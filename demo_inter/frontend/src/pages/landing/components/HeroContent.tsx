...
export function HeroContent() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pb-4 pt-10 sm:px-6 sm:pt-16">
      <div className="inline-block rounded-2xl bg-[#010E80] px-5 py-3">
        <img
      ...
      <h1 className="mt-5 max-w-3xl text-4xl font-extrabold leading-[1.1] tracking-tight text-slate-900 dark:text-white sm:text-5xl">
        {content["hero.title"]}
      </h1>
